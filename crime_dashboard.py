...
def load_datasets():
    # Load crime data
    crime_data = pd.read_csv("/home/zara/subway-surfers/data/CLEANED_NYPD_Arrest_Data_YTD")
    crime_data['ARREST_DATE'] = pd.to_datetime(crime_data['ARREST_DATE'])
    
    # Load subway stations data
    subway_stations = pd.read_csv("/home/zara/subway-surfers/data/SubwayEntranceData.csv")
